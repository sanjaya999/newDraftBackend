...
import { registerController, loginController, authCheck } from "../api/auth.controller.js";
...
describe("Auth Controller", () => {
  ...
  describe("registerController", () => {
    it("should register a user and set a cookie", async () => {
      ...
      expect(authService.registerUser).toHaveBeenCalledWith("Test User", "test@example.com", "password");
