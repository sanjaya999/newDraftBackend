...
import { addCollaboratorController, createDocumentController, getAllDocumentController, getDocumentController, updateDocumentController } from "../api/document.controller.js";
