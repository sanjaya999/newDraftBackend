...
import { addCollaboratorController, createDocumentController, getAllCollaborationDocumentController, getAllCollaborators, getAllDocumentController, getDocumentController, updateDocumentController } from "../api/document.controller.js";
...
documentRouter.get("/collaboration", authenticate, getAllCollaborationDocumentController);
documentRouter.get("/collaborators/:docID", authenticate, authorize("READ_DOCUMENT"),getAllCollaborators);
documentRouter.get("/:id" ,authenticate, validate(getDocumentSchema),getDocumentController);
documentRouter.get("/" ,authenticate, getAllDocumentController);
